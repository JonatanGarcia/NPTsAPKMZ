...
public class SiopDAO {
    ...
    public static Siop insertSiopCabezera(String cia, String estructura, String fechaSiop, String fechaOperacion, String proyecto, String activo, String equipo, String conductor, String espRotNM, String actividad, String fechaInicio, int idIntervencion, String resumenAnterior, String resumen, int consecutivo, int diasProg, String suptte) throws DBException {
        Siop siop=new Siop();        
    ...
    public static void insertSiopProfundidad(Siop idSiop, String tipo, int prof00, int prof24, int prof05, String avaInd, String ultCont, String proxCont) throws DBException {
    ...
    public static void insertSiopBarrena(Siop idSiop, String actualAnterior, String marca, String serie, float diametro, String tipo, String tobera, int metrosPerforados, String horasOperecion, float promedioPorMetro, String tresUltimosMts, float costoPorMetro, int ampInic, String desIADC) throws DBException {
    ...
    public static void insertSiopHerramienta(Siop idSiop, String herramienta, int cantidad, float longitud, String observaciones) throws DBException {
    ...
    public static void insertSiopTR(Siop idSiop, String ultimaTRd, String ultimaTRv, String proxTRd, String proxTRv, String bLd, String bLv, String c2, int consecutivo) throws DBException {
        Tr tr=new Tr();
    ...
    public static void insertNucleo(Siop idSiop, String nucleoR, String intProg, String intDisp) throws DBException {
    ...
    public static void insertSiopLodo(Siop idSiop, String lodo, float densidad, int viscosidad, float temperatura, float arena, float filtrado, float calcio, float enjarre, int alcalinidad, int gelCero, int gelDiez, int cloruros, float ph, float solidos, float aceite, float agua, int va, int vp, int yp, int emul, String raa, String mbt) throws DBException {
        Lodo lod=new Lodo();
    ...
    public static void insertSiopOperacion(Siop idSiop, String fechaIncio, String fechaFin, String actividad) throws DBException {
