 ...
 * JiActividades.java
 *
 * Created on 30/04/2013, 10:57:02 AM
 */
package testiisop;
 ...
 * @author Marco
 */
public class JiActividades extends javax.swing.JInternalFrame {

    /** Creates new form JiActividades */
    
    int id=0;
    public JiActividades() {        
        initComponents();
        Llenar(true, "");
        LlenarCombo();
    }
    ...
    public void Llenar(boolean tipoBuscar,String buscar){   
        ...
        model.addColumn("Secuencia");                
        try {
            
        List<CatActividades> listN1=ActividadesDAO.getListActividadesInter(tipoBuscar,buscar);//getListActividades(tipoBuscar,buscar);
        model.setNumRows(listN1.size());
        for(int i=0;i<listN1.size();i++){            
            model.setValueAt(listN1.get(i).getIdActividad(), i, 0);
            model.setValueAt(listN1.get(i).getStrNombre(), i, 1);
            model.setValueAt(new Multivalor(listN1.get(i).getCatIntervencion().getIdTipo(), listN1.get(i).getCatIntervencion().getStrNombre()), i, 2);
            model.setValueAt(listN1.get(i).getStrDesc(), i, 3);
            model.setValueAt(listN1.get(i).getSecuencia(), i, 4);            
        }
        listN1=null;
    ...
    public boolean Validar(){    
        ...
        if(JtxtSecuencia.equals("")){
            JOptionPane.showMessageDialog(rootPane,"Inserte un valor Numerico en Secuencia",Menu.nombreSistema, JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
    }
    public void Limpiar(){
        ...
        JtxNombre.setText("");
        JtxtDesc.setText("");
        JtxtSecuencia.setText("");                
    }
      public CatActividades iniciaCatAct(){
        CatActividades catActividades=new CatActividades();        
        catActividades.setStrNombre(JtxNombre.getText());
        catActividades.setStrDesc(JtxtDesc.getText());       
        catActividades.setSecuencia(Integer.parseInt(JtxtSecuencia.getText()));        
        CatIntervencion catIntervencion=new CatIntervencion(((Multivalor)JcInter.getSelectedItem()).getIndice());
        catActividades.setCatIntervencion(catIntervencion);        
    ...
    private void initComponents() {
        ...
        JtxtSecuencia = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(testiisop.TestIisopApp.class).getContext().getResourceMap(JiActividades.class);
        ...
        jSeparator1.setFont(resourceMap.getFont("jSeparator1.font")); // NOI18N
        ...
        JtxtSecuencia.setText(resourceMap.getString("JtxtSecuencia.text")); // NOI18N
        JtxtSecuencia.setName("JtxtSecuencia"); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(JtxtSecuencia)
                                    .addComponent(JcInter, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(JtxNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(JtxBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(JtxtSecuencia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
    ...
    private void JtxBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JtxBuscarKeyPressed
        // TODO add your handling code here:
        Llenar(false, JtxBuscar.getText());
}//GEN-LAST:event_JtxBuscarKeyPressed
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount()==2){
            ...
            if(fila>-1){                
                id =Integer.parseInt(jTable1.getModel().getValueAt(fila, 0).toString());
                nombre=jTable1.getValueAt(fila, 1).toString();
                combo=(Multivalor)jTable1.getValueAt(fila, 2);
                desc=jTable1.getValueAt(fila, 3).toString();
                secuencia=Integer.parseInt(jTable1.getValueAt(fila, 4).toString());
                JtxNombre.setText(nombre);        
                JcInter.setSelectedItem(combo);
                JtxtDesc.setText(desc);
                JtxtSecuencia.setText(secuencia+"");
            }
        }       
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if(id!=0){
            if(Validar()){
                boolean respuesta=ActividadesDAO.setUpdateCatAct(iniciaCatAct(),id);
                if (respuesta){
                    Limpiar();
            ...
            JOptionPane.showMessageDialog(rootPane, "Seleccione una Actividad de Lista", Menu.nombreSistema, JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
        if(Validar()){
            boolean respuesta=ActividadesDAO.setNewCatAct(iniciaCatAct());
            if (respuesta){
                Limpiar();
    ...
    private javax.swing.JTextField JtxtSecuencia;
